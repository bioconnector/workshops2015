...
subset(mtcars, cyl==6)
# Return only cars having more than 6 cylinders **and** an engine displacement volume less than 300cc.
subset(mtcars, cyl>6 & disp<300)
# Return only the cars that get at least 20 miles per gallon or have a displacement volume of less than 100cc.
...
subset(mtcars, cyl>=6 & mpg>=15)
subset(mtcars, cyl>=6 & mpg>=15)$disp
mean(subset(mtcars, cyl>=6 & mpg>=15)$disp)
```
...
paste("Answer:", with(subset(mtcars, cyl==8), mean(disp/hp)))
```
